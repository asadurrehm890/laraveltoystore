      ...
      <div class="row">
       ...
       <?php $img_id = explode(',', $single->img); ?>
        ...
        <div class="col-lg-7 col-md-12 col-sm-12 mobcenter">
                ...
                <form class="single-prod-form" action="index.html" method="post">
                  <label class="qont" for="">
                    <input type="text" name="quantity" value="1" class="rounded-pill form-control">
                    </label>
                    <button type="submit" class="btn1 border-0 d-block mt-3" name="button">Add to Cart <i class="ms-2 fa-solid fa-arrow-right"></i> </button>
                </form>
                <form class="single-wish-form" action="index.html" method="post">
                     <button type="button" class="btn2 border-0 mt-3" name="button">Add to whishlist <i class="ms-2 fa-solid fa-arrow-right"></i> </button>
                </form>
        </div>
      </div>
    </div>
