          ...
          <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-md-8 col-sm-12">
                  <div id="scene">
                    <div data-depth="0.2">
                      <img class="img-fluid" src="{{ asset('assets/img/bb.png') }}" alt="">
                   </div>
                   <div data-depth="0.4">
                     <img class="img-fluid" src="{{ asset('assets/img/bb2.png') }}" alt="">
                   </div>
 <div data-depth="0.8">
   <img class="img-fluid" src="{{ asset('assets/img/ban4.png') }}" alt="">
</div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 col-md-12">
                  <div class="position-relative text-center">
                    <img class="img-fluid w-100 mw300" src="./assets/img/4.png" alt="">
